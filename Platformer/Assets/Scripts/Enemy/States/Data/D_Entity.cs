...
[CreateAssetMenu(fileName = "newEntityData", menuName = "Data/Entity Data/Base Data")] //fileName is the name that the created asset is automatically named after, menuName is the name of the path to find and create the data
